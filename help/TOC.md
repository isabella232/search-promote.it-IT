...
+ Progettazione di una ricerca {#design}
   ...
   + [Barra laterale](c-about-design-menu/c-about-facet-rails.md)
...
+ Utilizzo della linguistica di ricerca {#linguistics}
   ...
   + [Intendevi](c-about-linguistics-menu/c-about-did-you-mean.md)
   + [Ignorare le impostazioni di espansione delle query](c-about-linguistics-menu/c-about-query-expansion-overrides.md)
...
+ Indicizzazione del contenuto {#index}
   ...
   + [Indice di ri-classificazione](c-about-index-menu/c-about-re-rank-index.md)
   + [Controllo remoto per indicizzazione](c-about-index-menu/c-about-remote-control-for-indexing.md)
...
+ Appendici {#appendices}
   ...
   + [Ricerca per prossimità](c-appendices/r-about-proximity-search.md)
   + [Modelli](c-appendices/c-templates.md)
   + [Parametri CGI](c-appendices/c-cgiparameters.md)
   + [Ricerca di moduli](c-appendices/c-searchforms.md)
   + [Uscita di ricerca guidata](c-appendices/c-guidedsearchoutput.md)
