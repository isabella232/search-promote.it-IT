...
Consultate [Configurazione delle preferenze](../c-about-settings-menu/c-about-my-profile-menu.md#task_5E06BF565C284C2EBBE18E10A1C4BFBB).

Consultate [Modifica della password di accesso](../c-about-settings-menu/c-about-my-profile-menu.md#task_F5FF13AAD1514FE997C8882D4537C0C9)
...
Consultate [Visualizzazione dei privilegi](../c-about-settings-menu/c-about-my-profile-menu.md#task_6107C5BA333B4053A56325AE5E3A1848)di accesso.

**Per configurare le informazioni personali degli utenti**

1. Nel menu del prodotto, fate clic su **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]**.
1. Nella [!DNL Personal Information] pagina, specificate i campi desiderati.

   È obbligatorio solo il [!DNL Email Address] campo.
...
1. Nel menu del prodotto, fate clic su **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL My Preferences]**.
1. Nella [!DNL My Preferences] pagina, impostare i campi desiderati.
   ...
   | Convalida attributi di tag modello al salvataggio | Durante il salvataggio di un modello nell&#39;Editor modelli, convalida tutti gli attributi in &lt;guidati-*> e &lt;search-*>.  Consultate [Modifica di una presentazione o di un modello](../c-about-design-menu/c-about-templates.md#task_800E0E2265C34C028C92FEB5A1243EC3)di trasporto. |
   | Convalida riferimento modello a oggetti GS al salvataggio | Controlla l&#39;esistenza di oggetti Guided Search, quali menu, facet, breadcrumb, var personalizzate e modelli, a cui si fa riferimento nei tag &lt;guidate-*>. |
...
Se perdete o dimenticate la password, fate clic **[!UICONTROL Forgot your password?]** sulla pagina di accesso e seguite le istruzioni per generare una nuova password.
...
1. Nel menu del prodotto, fate clic su **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Password]**.
1. Nella [!DNL Change Password] pagina, nel [!DNL Current Password] campo, digitate la password di accesso corrente utilizzata.
1. Nel [!DNL New Password] campo e nel [!DNL New Password (again)] campo, digitate la nuova password di accesso che desiderate utilizzare.
1. Fai clic su **Salva le modifiche**.
...
1. Trasferimento della proprietà dell&#39;account a un altro utente dell&#39;account.
   ...
   Consultate [Trasferimento della proprietà dell&#39;account a un altro utente](../c-about-settings-menu/c-about-account-options-menu.md#task_47E3C66CC6374274830DA10171E0CF17)dell&#39;account.
1. Nel menu del prodotto, fate clic su **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Cancel]**.
1. Sulla [!DNL Cancel Login] pagina, fate clic su **[!UICONTROL Cancel Login]**.
1. Fare clic **[!UICONTROL Yes]** per confermare l&#39;annullamento.
...
1. Nel menu del prodotto, fate clic su **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL My Access Privileges]**.
1. Nella [!DNL My Access Privileges] pagina, espandete le viste della struttura per controllare i privilegi o l&#39;accesso limitato.
