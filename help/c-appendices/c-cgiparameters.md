...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Consente di ignorare la ricerca durante la generazione dei rapporti. </p> <p>Utilizzate questa query per mascherare alcune ricerche di back-end, ad esempio ricerche generate da Did You Mean o ricerche generate da un amministratore nel centro membri. Poiché un utente finale non genera questi tipi di ricerca, non vengono visualizzati in vari rapporti di Adobe Search&amp;Promote. </p> <p>I valori validi sono <span class="codeph"> sp_i=1 </span> e <span class="codeph"> sp_i=2 </span>. </p> </td> 
  </tr> 
  <tr> 
